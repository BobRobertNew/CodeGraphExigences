...
class TestQueryHandler(unittest.TestCase):
    ...
    def test_get_total_node_count(self):
        ...
        self.repo.add_node(n1, owner='TestOwner')
        self.repo.add_node(n2, owner='TestOwner')
    ...
    def test_get_exigences_for_project(self):
        ...
        self.repo.add_node(proj, owner='TestOwner')
        self.repo.add_node(exg1, owner='TestOwner')
        self.repo.add_node(exg2, owner='TestOwner')
    ...
    def test_get_exigences_with_rex_for_project(self):
        ...
        self.repo.add_node(exg1, owner='TestOwner')
        self.repo.add_node(exg2, owner='TestOwner')
        self.repo.add_node(rex1, owner="TestOwner")
        self.repo.add_edge(Edge(source_id="p1", target_id="e1", type="LINKED_TO"))
        self.repo.add_edge(Edge(source_id="p1", target_id="e2", type="LINKED_TO"))
    ...
    def test_get_exigences_for_project_and_metier(self):
        ...
        self.repo.add_node(exg1, owner='TestOwner')
        self.repo.add_node(exg2, owner='TestOwner')
        self.repo.add_node(metier, owner="TestOwner")
        self.repo.add_edge(Edge(source_id="p1", target_id="e1", type="LINKED_TO"))
        self.repo.add_edge(Edge(source_id="p1", target_id="e2", type="LINKED_TO"))
    ...
    def test_get_connected_nodes(self):
        ...
        self.repo.add_node(exg2, owner='TestOwner')
        self.repo.add_node(rex1, owner="TestOwner")
        self.repo.add_node(rex2, owner="TestOwner")
        self.repo.add_node(metier1, owner="TestOwner")
        self.repo.add_edge(Edge(source_id="e1", target_id="r1", type="LINKED_TO"))
    ...
    def test_get_preuves_connection_status_for_project(self):
        ...
        self.repo.add_node(exg1, owner='TestOwner')
        self.repo.add_node(exg2, owner='TestOwner')
        self.repo.add_node(preuve1, owner="TestOwner")
        self.repo.add_node(preuve2, owner="TestOwner")
        self.repo.add_node(preuve3, owner="TestOwner")
        self.repo.add_node(doc1, owner="TestOwner")
        self.repo.add_node(doc2, owner="TestOwner")
    ...
    def test_get_exigencies_with_multiple_sous_articles(self):
        ...
        self.repo.add_node(exg1, owner='TestOwner')
        self.repo.add_node(exg2, owner='TestOwner')
        self.repo.add_node(sart1, owner='TestOwner')
        self.repo.add_node(sart2, owner="TestOwner")
        self.repo.add_node(sart3, owner="TestOwner")
    ...
    def test_get_sous_articles_with_multiple_articles(self):
        ...
        self.repo.add_node(sart1, owner='TestOwner')
        self.repo.add_node(sart2, owner="TestOwner")
        self.repo.add_node(art1, owner="TestOwner")
        self.repo.add_node(art2, owner="TestOwner")
        self.repo.add_node(art3, owner="TestOwner")
    ...
    def test_complete_pivot_excel_with_graph_info(self):
        ...
        self.repo.add_node(exg, owner='TestOwner')
        self.repo.add_node(phase_etude, owner="TestOwner")
        self.repo.add_node(metier_gc, owner="TestOwner")
        self.repo.add_node(preuve, owner="TestOwner")
        self.repo.add_node(doc, owner="TestOwner")
