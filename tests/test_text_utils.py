...
class TestTextUtils(unittest.TestCase):
    ...
    def test_find_best_match_single_choice(self):
        choices = ["only_option"]
        self.assertEqual(find_best_match("only", choices, threshold=50), "only_option")

    def test_find_best_match_special_chars_only(self):
        choices = ["!@#$", "%^&*"]
        self.assertEqual(find_best_match("!@#$", choices, threshold=100), "!@#$")
    ...
    def test_find_best_match_large_choices(self):
        ...
        self.assertEqual(find_best_match("target_choice", choices, threshold=100), "target_choice")

    def test_find_best_match_very_low_score_match(self):
        choices = ["abcdefghij", "klmnopqrst"]
