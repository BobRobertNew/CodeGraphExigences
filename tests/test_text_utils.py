...
class TestTextUtils(unittest.TestCase):
    ...
    def test_find_best_match_single_choice_exact(self):
        self.assertEqual(find_best_match("apple", ["apple"]), "apple")

    def test_find_best_match_single_choice_no_match(self):
        self.assertIsNone(find_best_match("apple", ["banana"]))

    def test_find_best_match_superstring_query(self):
        self.assertEqual(find_best_match("applesauce", ["apple", "banana"]), "apple")

    def test_find_best_match_almost_exact_match(self):
        self.assertEqual(find_best_match("aple", ["apple", "banana"]), "apple")
    ...
    def test_find_best_match_with_score_single_choice_exact(self):
